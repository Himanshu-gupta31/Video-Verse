...
const getChannelStatusTotalVideos = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new Apisuccess(200, "Total video count fetched successfully", {
...
const getChannelStatusTotalSubscriber = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new Apisuccess(200, "Total subscriber fetched successfully", {
        totalSubscriber,
      }),
    );
});
const getChannelVideos = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new Apisuccess(200, "All videos fetched successfully", { channelVideo }),
    );
  } catch (error) {
    return res
    .status(200)
    .json(
      new Apisuccess(200, "All videos fetched successfully",error ),
    );
  }
});
export {
  ...
  getChannelVideos,
  getChannelStatusTotalVideos,
  getChannelStatusTotalSubscriber,
};
