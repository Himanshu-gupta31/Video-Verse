  ...
  return (
    <>
      ...
      <div
        ...
        } md:translate-x-0 md:relative md:w-64 md:h-full md:flex md:flex-col md:top-0 md:left-0 z-50`}
      >
        <div className="flex flex-col p-4">
          ...
          <Link to="/twitter" onClick={() => setIsOpen(false)}>
            <Sidebar
              icon={
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <Link to="/watchHistory" onClick={() => setIsOpen(false)}>
            <Sidebar
              icon={
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <Link to="/playlist" onClick={() => setIsOpen(false)}>
            <Sidebar
              icon={
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            className="w-full h-[2rem] rounded-md mt-4 font-serif text-white border border-white"
            onClick={logoutUser}
          >
            Logout
          </button>
