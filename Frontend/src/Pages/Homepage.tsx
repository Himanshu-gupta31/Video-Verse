    ...
    return (
        <div className="bg-black w-screen h-screen overflow-y-hidden flex">
            ...
            <div className="flex-shrink-0 w-36 mt-2">
                <Sidebar SidebarTitle="Home" classname="mt-20 ml-20" />
                <Sidebar SidebarTitle="Shorts" classname="mt-3 ml-20" />
                <Sidebar SidebarTitle="Subscription" classname="mt-3 ml-20 mb-4" />
                <div className="border-t w-[17rem] bg-slate-500"></div>
                <Sidebar SidebarTitle="Your channel" classname="mt-3 ml-20 w-full" />
                <Sidebar SidebarTitle="History" classname="mt-3 ml-20 w-full" />
                <Sidebar SidebarTitle="Playlist" classname="mt-3 ml-20 w-full" />
                <Sidebar SidebarTitle="Your Videos" classname="mt-3 ml-20 w-full" />
                <Sidebar SidebarTitle="Liked Videos" classname="mt-3 ml-20 w-full mb-4" />
                <div className="border-t w-[17rem] bg-slate-500"></div>
            </div>
